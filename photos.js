...
function previewFive() {
   ...
   //locate first element where the tag is article to a variable
...
//the leftArrow() function will be exectued when the user click the left mavigation arrow button
leftarrow.addEventListener("click", leftArrow, false);

//declare varible for document element with id of rightarrow in the html document
var rightarrow = document.getElementById("rightarrow");

//add an event handler to the specified document element (rightarrow)
//the rightArrow() function will be executed when user clicks the right naviation arrow
